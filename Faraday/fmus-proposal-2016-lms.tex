...
\includepdf[pages=-]{Students/Bauson/Bauson-Application}
\includepdf[pages=-]{Students/Hall/Hall-Application}
\includepdf[pages=-]{Students/Josten/Josten-Application}
\includepdf[pages=-]{Students/Stamper/Stamper-Application}
...
%  LocalWords:  modalities Bauson Josten Visicalc pre Visicalc's MOOC EdX TN's
%  LocalWords:  Coursera Udacity tradi tional nology iGrad iChair KK KK's rlrr
%  LocalWords:  llll
