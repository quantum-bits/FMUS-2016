...
KK is a theoretical physicist by training and has had extensive
experience supervising student research at Taylor, primarily
on National Science Foundation-funded projects in physics.  He has
also had significant programming experience,
%
% software development experience?
%
and over the last three and half years he has developed much of the
code base for three web-based applications that are used on campus:
{\tt iGrad}, {\tt Budget Tracker} and {\tt iChair}.  {\tt iGrad} and
{\tt Budget Tracker} are used within the Physics and Engineering
Department to help students formulate their four-year plans, and to
help track the department budget, respectively.  {\tt iChair} is used
by several departments on campus as a faculty load planning and
visualization tool.  KK also has significant teaching experience and
was recently recognized by the Alumni Association as the 2015
Distinguished Professor.  In addition, KK's background as a department
chair gives him a perspective that would be useful to the project.
While KK's primary scholarly emphasis will likely continue to be in
theoretical particle physics, the technological and educational
aspects of the proposed project are of significant interest to him.
